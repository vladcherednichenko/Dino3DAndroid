...
void main(){
    ...
    color[0] +=  (1.0 - color[0]) * u_Red;
    color[1] -= color[1] * u_Red;
    color[2] -= color[2] * u_Red;
...
//    diffuse = diffuse * (frontLightIntensity / (1.0+ (2.5 * distance * distance)));
//    return diffuse;
//
//}
